...
import com.example.hebatsitubondo.Admin.Data_Input_Portofolio;
...
import com.example.hebatsitubondo.Preferences;
...
public class Akun_Profile extends AppCompatActivity {
    ...
    TextView nama_profil, username_profil, email, no_handphone, status_profile, update_profil_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akun_profile);

        Toolbar toolbarakun = findViewById(R.id.toolbarakun);
        setSupportActionBar(toolbarakun);
        getSupportActionBar().setTitle("Akun User");

        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        fotoprofil = (CircularImageView) findViewById(R.id.fotoprofil);
        ...
        update_profil_user = (TextView) findViewById(R.id.updateuser);
        ...
        fotoprofil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImagePicker.Companion.with(Akun_Profile.this)
        ...
        //update
        update_profil_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Akun_Profile.this, Update_user.class);
...
//                intent.putExtra("photo_dokumentasi", modelDokumentasiKegiatan.getPhotoDokumentasi());
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Akun_Profile.this, Login.class);
                finish();
                startActivity(intent);
            }
        });
    ...
    private void sendData (final String decoded){
        ...
        StringRequest srSendData = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Akun_Profile.this, "Maaf ada kesalahan Upload Foto  ", Toast.LENGTH_LONG).show();
                pDialog.dismiss();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Akun_Profile.this);
